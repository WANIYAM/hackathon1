...
**Branch**: `006-vla-humanoid-robotics` | **Date**: 2025-12-20 | **Spec**: [spec.md](spec.md)
**Input**: Feature specification from `specs/006-vla-humanoid-robotics/spec.md`

## Summary

This plan outlines the creation of a new Docusaurus module (Module 4) with three chapters on Vision-Language-Action for humanoid robotics. The technical approach is to add a new directory in `ros2-docs/docs` for the module, create three markdown files for the chapters, and update `ros2-docs/sidebars.js` to include the new module.
...
```text
specs/006-vla-humanoid-robotics/
├── plan.md              # This file
